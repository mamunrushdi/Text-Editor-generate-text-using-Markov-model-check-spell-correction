...
public class NearbyWords implements SpellingSuggest {
	...
	public void deletions(String s, List<String> currentList, boolean wordsOnly )
	{
		for(int index = 0; index < s.length(); index++)
		{
			...
			//if the item isn't in the list, isn't the original string, and (if the wordsOnly is true) is a real word
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		List<String> numOfWordsToLook = new ArrayList<>();
		 ...
		 */
		while(!queue.isEmpty() && retList.size() < numSuggestions && numOfWordsToLook.size() < THRESHOLD)
		{
			String curr = queue.remove();
			numOfWordsToLook.add(curr);
